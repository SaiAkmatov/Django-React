# Generated by Django 3.2.5 on 2021-07-16 20:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fullname', models.CharField(blank=True, max_length=350, verbose_name='Ф.И.О')),
                ...
                ('phone_number', models.CharField(max_length=17, validators=[django.core.validators.RegexValidator(message="Пример телефоного формата: '+999999999'.", regex='^\\+?1?\\d{9,15}$')])),
            ...
            managers=[
                ('objects', customUser.models.MyUserManager()),
            ],
        ),
    ]
